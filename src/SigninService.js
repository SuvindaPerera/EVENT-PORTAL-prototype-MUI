    ...
    const[phoneError, setPhoneError] = useState(false)
     ...
     const handleSubmit = (e) =>{
      ...
      setPhoneError(false)
        ...
        if ((companyName && companyDescription && password && confirmPassword && email)
            &&
            (password === confirmPassword)){
                console.log(companyName,companyDescription,email,password,confirmPassword,phone)
        }
        if (companyName === ''){
    ...
    <Box sx={{ flexGrow: 1 , bgcolor:'lightcyan' }}>
        <NavbarforLogIn/>
            <Container   maxWidth="sm">
                <Box sx={{ flexGrow: 1, bgcolor:'#fff'  }} p={5} justifyContent="center" >

                <Typography variant="h5"margin="20px">Sign In</Typography>
                <Typography variant="body2"margin="15px">as a Service Provider</Typography>
